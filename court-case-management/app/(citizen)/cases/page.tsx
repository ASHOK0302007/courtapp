...
export default async function CitizenCasesPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-medium text-ink-900">My cases</h1>
      <p className="mt-1 text-sm text-ink-500">Every case you&apos;ve filed, and where it stands.</p>

      <Card className="mt-6">
        <CardContent className="p-0">
          {!cases || cases.length === 0 ? (
            <p className="p-5 text-sm text-ink-500">
              No cases yet. <Link href="/cases/new" className="text-brass-500 hover:underline">File an appeal</Link>.
            </p>
          ) : (
